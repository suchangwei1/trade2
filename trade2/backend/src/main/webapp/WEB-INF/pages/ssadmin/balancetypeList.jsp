...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/saveBalancetype.html">
				<li><a class="add"
			...
			<shiro:hasPermission name="ssadmin/deleteBalancetype.html">
				<li><a class="delete"
					href="ssadmin/deleteBalancetype.html?uid={sid_user}"
					target="ajaxTodo" title="确定要删除吗?"><span>删除</span> </a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/updateBalancetype.html">
				<li><a class="edit"
		...
		<thead>
			<tr>
				...
				<th width="60" orderField="fday"
                    <c:if test='${param.orderField == "fday" }'> class="${param.orderDirection}"  </c:if>>周期天数</th>
		...
		<tbody>
			<c:forEach items="${balancetypeList}" var="balancetype"
				...
				<tr target="sid_user" rel="${balancetype.fid}">
					...
					<td><fmt:formatNumber value="${balancetype.frate}" pattern="##.######" maxIntegerDigits="10" maxFractionDigits="4"/></td>
