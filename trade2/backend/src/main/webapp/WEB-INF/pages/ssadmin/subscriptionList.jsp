...
<form id="pagerForm" method="post" action="ssadmin/subscriptionList.html">
	<input type="hidden" name="status" value="${param.status}"> 
	<input type="hidden" name="keywords" value="${keywords}" /> 
	<input type="hidden" name="ftype" value="${param.ftype}" />
	<input type="hidden" name="ftype1" value="${param.ftype1}" />
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="ssadmin/subscriptionList.html" method="post">
		<div class="searchBar">

			<table class="searchContent">
				<tr>
					<td>认购虚拟币类型： <select type="combox" name="ftype">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/addSubscription.html">
				<li><a class="add" href="ssadmin/goSubscriptionJSP.html?url=ssadmin/addSubscription"
					height="430" width="800" target="dialog" rel="addSubscription"><span>新增</span> </a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/updateSubscription.html">
				<li><a class="edit"
					href="ssadmin/goSubscriptionJSP.html?url=ssadmin/updateSubscription&uid={sid_user}"
					height="430" width="800" target="dialog" rel="updateSubscription"><span>修改</span> </a></li>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="ssadmin/subscriptionLogList.html">
				<li><a class="edit" href="ssadmin/subscriptionLogList.html?parentId={sid_user}"
					height="500" width="800" target="dialog" rel="subscriptionLogList"><span>查看认购记录</span> </a></li>
			</shiro:hasPermission>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="60" orderField="fvirtualcointype.fname"
					<c:if test='${param.orderField == "fvirtualcointype.fname" }'> class="${param.orderDirection}"  </c:if>>认购虚拟币类型</th>
		...
		<tbody>
			<c:forEach items="${subscriptionList}" var="subscription" varStatus="num">
