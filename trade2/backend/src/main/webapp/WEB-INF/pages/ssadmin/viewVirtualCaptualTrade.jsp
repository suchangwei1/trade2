...
<h2 class="contentTitle">手动审核虚拟币提现<font color="red">(钱包币种已经转出，数据库没有更新,请谨慎操作)</font></h2>


<div class="pageContent">

	<form method="post" action="ssadmin/virtualCapitalOutAuditTrade.html"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			<dl>
				<dt>交易号：</dt>
				<dd>
					<input type="text" name="tradeNo" maxlengpahx="50"  size="40"/>
				</dd>
			</dl>
			<dl>
				<dt>会员登陆名：</dt>
