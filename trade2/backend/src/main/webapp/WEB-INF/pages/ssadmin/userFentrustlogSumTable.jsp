...
<form id="pagerForm" method="post" action="ssadmin/userFentrustlogSumTable.html">
...
<div class="pageHeader">
	<form id="queryForm" onsubmit="return navTabSearch(this);"
		action="ssadmin/userFentrustlogSumTable.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
      ...
      <shiro:hasPermission name="ssadmin/exportUserFentrustlogSumTable.html">
				<li><a class="icon" target="dwzExport" title="确定要导出历史成交单列表吗？" href="/ssadmin/exportUserFentrustlogSumTable.html"><span>导出列表</span></a>
				</li>
      </shiro:hasPermission>
		</ul>
	</div>
		...
		<thead>
			...
			<%--	<th width="60" >会员手机号</th>
				...
				<th width="60" orderField="l.fAmount"
					<c:if test='${param.orderField == "l.fAmount"}'> class="${param.orderDirection}"  </c:if>>数量</th>
				<th width="60" orderField="l.ffees"
						<c:if test='${param.orderField == "l.fee"}'> class="${param.orderDirection}"  </c:if>>手续费</th>
