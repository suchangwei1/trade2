...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/updateQuestion.html">
				<li><a class="edit"
			...
			<shiro:hasPermission name="ssadmin/deleteQuestion.html">
				<li><a class="edit"
					   href="ssadmin/deleteQuestion.html?uid={sid_user}"
					   target="ajaxTodo" rel="updateLink"><span>删除</span>
				</a>
				</li>
			</shiro:hasPermission>
		</ul>
		...
		<thead>
			<tr>
				...
				<th width="60" orderField="fname"
					<c:if test='${param.orderField == "fname"}'> class="${param.orderDirection}"  </c:if>>提问人</th>
				<th width="60" orderField="ftelephone"
					<c:if test='${param.orderField == "ftelephone"}'> class="${param.orderDirection}"  </c:if>>手机号码</th>
