...
<form id="pagerForm" method="post" action="ssadmin/entrustList.html?entype=1">
	<input type="hidden" name="status" value="${param.status}"> <input
		...
		type="hidden" name="entype" value="1" /> <input type="hidden"
...
<div class="pageHeader">
	<form id="queryForm" onsubmit="return navTabSearch(this);"
		action="ssadmin/entrustList.html?entype=1" method="post">
		<div class="searchBar">
		...
		<tbody>
			<c:forEach items="${entrustList}" var="entrust" varStatus="num">
				<tr target="sid_user" rel="${entrust.fid}">
					...
					<td>${typeMap[entrust.market.buyId] }</td>
					<td>${typeMap[entrust.market.sellId]}</td>
