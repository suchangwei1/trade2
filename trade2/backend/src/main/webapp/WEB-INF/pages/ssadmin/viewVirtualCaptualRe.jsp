...
<h2 class="contentTitle">重新审核虚拟币提现<font color="red">(数据库已经修改,钱包转币没有成功,此过程不可逆,请谨慎操作)</font></h2>


<div class="pageContent">

	<form method="post" action="ssadmin/reVirtualCapitalOutAudit.html"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			<dl>
				<dt>钱包密码：</dt>
				<dd>
					<input type="text" name="fpassword" maxlengpahx="50"  size="40"/>
				</dd>
			</dl>
			<dl>
				<dt>会员登陆名：</dt>
