...
<div class="pageContent">
	...
	<form method="post" action="ssadmin/saveLink.html" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)">
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				<dt>链接地址：</dt>
				<dd>
					<input type="text" name="link.furl" maxlength="100" class="required" size="70"/>
				</dd>
			</dl>
			<dl>
				<dt>描述：</dt>
