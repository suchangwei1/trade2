...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/addLimittrade.html">
				<li><a class="add"
					href="ssadmin/goLimittradeJSP.html?url=ssadmin/addLimittrade&type=2" height="300"
					width="800" target="dialog" rel="addLimittrade"><span>新增</span> </a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/deleteLimittrade.html">
				<li><a class="delete"
					href="ssadmin/deleteLimittrade.html?uid={sid_user}" target="ajaxTodo"
					title="确定要删除吗?"><span>删除</span> </a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/updateLimittrade.html">
				<li><a class="edit"
