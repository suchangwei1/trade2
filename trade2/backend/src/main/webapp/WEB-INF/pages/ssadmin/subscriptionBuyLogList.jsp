...
<form id="pagerForm" method="post"
	action="ssadmin/subscriptionBuyLogList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="ssadmin/subscriptionBuyLogList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			<c:forEach items="${subscriptionBuyLogList}" var="subscriptionBuyLog"
				varStatus="num">
