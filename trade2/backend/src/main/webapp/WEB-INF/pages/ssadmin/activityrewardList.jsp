...
<form id="pagerForm" method="post"
	action="ssadmin/activityrewardList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="ssadmin/activityrewardList.html" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/addActivityReward.html">
				<li><a class="add"
					href="ssadmin/goActivityRewardJSP.html?url=ssadmin/addActivityReward&aid=${aid}"
					height="350" width="800" target="dialog" rel="addActivityReward"><span>新增</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/updateActivityReward.html">
				<li><a class="edit"
					href="ssadmin/goActivityRewardJSP.html?url=ssadmin/updateActivityReward&uid={sid_user}"
					height="350" width="800" target="dialog" rel="updateActivityReward"><span>修改</span>
				</a>
				</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="ssadmin/deleteActivityReward.html">
				<li><a class="delete"
					href="ssadmin/deleteActivityReward.html?uid={sid_user}"
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="60" orderField="fvirtualcointype.fname"
					<c:if test='${param.orderField == "fvirtualcointype.fname" }'> class="${param.orderDirection}"  </c:if>>奖励虚拟币类型</th>
		...
		<tbody>
			<c:forEach items="${activityrewardList}" var="activityreward"
				varStatus="num">
