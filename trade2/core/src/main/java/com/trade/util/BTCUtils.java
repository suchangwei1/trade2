...
public class BTCUtils {
	...
	public List<BTCInfo> listtransactionsValue(int count, int from) throws Exception {
        ...
        if(json.containsKey("result") && !json.get("result").toString().equals("null")){
        	...
        	while(it.hasNext()){
        		Map map = (Map)it.next();
				System.out.println("00110:"+map.get("category").toString());
				if(map.get("category").toString().equals("receive")){
					System.out.println("++++++++++++++++++++++++++++++++++++");
					BTCInfo info = new BTCInfo();
					System.out.println("11111:"+map.get("account")+"");
					System.out.println("22222:"+map.get("address")+"");
					System.out.println("33333:"+map.get("amount")+"");
					System.out.println("44444:"+map.get("category")+"");
					System.out.println("55555:"+map.get("comment")+"");
	 ...
	 * @throws Exception
	 */
	public com.alibaba.fastjson.JSONObject activeaddress(String address) throws Exception {
		String s = main("registaccounttx", "[\""+address+"\"]");
