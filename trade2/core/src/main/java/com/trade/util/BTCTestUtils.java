...
public class BTCTestUtils {
	...
	public BTCTestUtils(BTCMessage btcMessage) {
	...
	public String getNewaddressValueForAdmin(String userId) throws Exception {
		String result = null;
		if(PASSWORD != null && PASSWORD.trim().length() >0  && PASSWORD.toLowerCase().indexOf("btc") != -1){
	 ...
	 * @throws Exception
	 */
	public com.alibaba.fastjson.JSONObject activeaddress(String address, Integer amount) throws Exception {
		if(PASSWORD != null && PASSWORD.trim().length() >0){
			JSONObject json = walletpassphrase(30);
			if(json.containsKey("error") && !"null".equals(json.getString("error"))&& json.getString("error")!=null){
				System.out.println("error pass=" + PASSWORD + "!");
				throw new Exception("钱包密码错误");
			}
		}
		String s = main("registaccounttx", "[\""+address+"\","+amount+"]");
		if(PASSWORD != null && PASSWORD.trim().length() >0){
			walletlock();
		}
...
//		System.out.println(result);
	...
	/*public static void main(String args[]) throws Exception{
		ACCESS_KEY = "actuser";
		SECRET_KEY = "actpassword";
		IP = "127.0.0.1";
		PORT = "8340";
		String password= "234";
		int times = 30;
		String ret = main("getbalance","[\""+password+"\","+times+"]");
		System.out.println(ret);
	}*/
	public static void main(String args[]) throws Exception{
		ACCESS_KEY = "edtuser";
		SECRET_KEY = "edtpassword";
		IP = "127.0.0.1";
		PORT = "10801";
		String password= "234";
		int times = 30;
		String ret = main("getbalace", "[\""+111+"\"]");
		System.out.println(ret);
	}
