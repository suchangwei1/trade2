...
//	  this.hibernateTemplate.setCacheQueries(true) ;//fake hank
	...
	public List findByParam(final int firstResult, final int maxResults, final String filter, final boolean isFY, final String CLASS) {
		List list = null;
		try {
...
//			list = queryObject.list();
			...
			list = getHibernateTemplate().executeFind(new HibernateCallback<List>() {
				@Override
